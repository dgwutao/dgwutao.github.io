    ...
    <footer>
        <div class="footer-container">
            ...
            <div class="footer-col">
                <h4>Projects</h4>
                <ul>
                    <li><a href="#">Sobha Hartland</a></li>
                    <li><a href="#">Sobha Creek Vista</a></li>
                    <li><a href="#">Sobha Greens</a></li>
                    <li><a href="#">Sobha Hartland Greens</a></li>
                    <li><a href="#">Sobha Creek Vistas</a></li>
                    <li><a href="#">Sobha Reserve</a></li>
                </ul>
            </div>
...
// register component
customElements.define('footer-component-modern', CustomFooter);